...
**Ambiente:** local, sobre la rama `develop` integrada, con el repositorio remoto todavía **privado** (PD-05)
...
|---|---|---|
| Python con `python-docx` | `python3 -c "import docx"` sin error | Instalado en el entorno de trabajo |
| LibreOffice headless | `soffice --version` devuelve 26.8 | Verificado el 2026-09-17 |
| Hook local | `git config core.hooksPath` devuelve `.githooks` | Instalado antes de E2E-07 |
| Repositorio remoto | `gh repo view --json visibility` devuelve `PRIVATE` | Creado en T-01 |
| `.secrets` | Existe en `privado/` y no aparece en `git status` | Creado en T-11 |
| Oferta ficticia | `privado/generados/PRUEBA-northwind/oferta-fuente.txt` | Redactada antes de E2E-01 |
...
**Evidencia:** salida de `ls -1` del directorio y contenido de `match.md`
...
**Resultado obtenido:** Pendiente de ejecución
**Evidencia:** salida de los recuentos y primeras líneas del texto extraído de ambos formatos
**Fecha y ejecutor:** pendiente
**Incidencia:** Ninguna
...
**Resultado obtenido:** Pendiente de ejecución
**Evidencia:** ambos `cv.md`, con las secciones de encabezado citadas
**Fecha y ejecutor:** pendiente
**Incidencia:** Ninguna
...
**Resultado obtenido:** Pendiente de ejecución
**Evidencia:** mensaje de detención y `ls` del directorio mostrando que no hay `.docx` ni `.pdf`
**Fecha y ejecutor:** pendiente
**Incidencia:** Ninguna
...
**Resultado obtenido:** Pendiente de ejecución
**Evidencia:** salida de `diff` y de `sha256sum` de ambos archivos
**Fecha y ejecutor:** pendiente
**Incidencia:** Ninguna
...
**Resultado obtenido:** Pendiente de ejecución
**Evidencia:** `match.md` y búsqueda de ambos términos en `cv.md` sin resultados
**Fecha y ejecutor:** pendiente
**Incidencia:** Ninguna
...
**Resultado obtenido:** Pendiente de ejecución
**Evidencia:** códigos de salida y mensajes de los tres intentos
**Fecha y ejecutor:** pendiente
**Incidencia:** Ninguna
...
**Resultado obtenido:** Pendiente de ejecución
**Evidencia:** códigos de salida y patrón citado
**Fecha y ejecutor:** pendiente
**Incidencia:** Ninguna
...
**Resultado obtenido:** Pendiente de ejecución
**Evidencia:** enlace a la ejecución del flujo y captura del estado del Pull Request
**Fecha y ejecutor:** pendiente
**Incidencia:** Ninguna
...
**Resultado obtenido:** Pendiente de ejecución
**Evidencia:** enlace a la ejecución del flujo
**Fecha y ejecutor:** pendiente
**Incidencia:** Ninguna
...
**Resultado obtenido:** Pendiente de ejecución
**Evidencia:** el informe y `git status` de `profile/` sin modificaciones
**Fecha y ejecutor:** pendiente
**Incidencia:** Ninguna
...
**Resultado obtenido:** Pendiente de ejecución
**Evidencia:** las tres versiones sucesivas de la entrada
**Fecha y ejecutor:** pendiente
**Incidencia:** Ninguna
...
**Resultado obtenido:** Pendiente de ejecución
**Evidencia:** `privado/analitica.md` completo
**Fecha y ejecutor:** pendiente
**Incidencia:** Ninguna
...
**Resultado obtenido:** Pendiente de ejecución
**Evidencia:** salida de ambas búsquedas y la sección de experiencia del `cv.md`
**Fecha y ejecutor:** pendiente
**Incidencia:** Ninguna
...
|---|---|---|---|
| E2E-01 | Pendiente | — | Ninguna |
| E2E-02 | Pendiente | — | Ninguna |
| E2E-03 | Pendiente | — | Ninguna |
| E2E-04 | Pendiente | — | Ninguna |
| E2E-05 | Pendiente | — | Ninguna |
| E2E-06 | Pendiente | — | Ninguna |
| E2E-07 | Pendiente | — | Ninguna |
| E2E-08 | Pendiente | — | Ninguna |
| E2E-09 | Pendiente | — | Ninguna |
| E2E-10 | Pendiente | — | Ninguna |
| E2E-11 | Pendiente | — | Ninguna |
| E2E-12 | Pendiente | — | Ninguna |
| E2E-13 | Pendiente | — | Ninguna |
| E2E-14 | Pendiente | — | Ninguna |

Un recorrido solo se marca aprobado cuando se ejecutó sobre el SHA declarado de
`develop` y su resultado coincide con el esperado. Un caso bloqueado no cuenta
como aprobado. El mensaje «terminado» de un subagente no es evidencia.
